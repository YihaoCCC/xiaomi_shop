    ...
    <div class="confirm">
        <div class="order-confirm clearfloat">
            ...
            <div class="addressFooter">
                <button type="button" class="btn btn-big  btn-default " @click="goToCart">返回购物车</button>
                <button type="button" class="btn btn-big" @click="goPay"> 去结算</button>
            </div>
        </div>
        <modal
                title="删除地址"
